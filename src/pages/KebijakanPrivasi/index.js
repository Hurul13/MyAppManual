    ...
    <ScrollView style={styles.all}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.judulBar}>Kebijakan Privasi</Text>
        </View>
        <View style={styles.box}>
          <Text style={styles.text}>Privacy Policy for Homei</Text>
          <Text style={styles.text2}>
            At Homei, accessible from https://homei.co.id/, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Homei and how we use it. If you have additional
            ...
            regards to the information that they shared and/or collect in Homei.
            This policy is not applicable to any information collected offline
            or via channels other than this website.
          </Text>
          <Text style={styles.text1}>Consent</Text>
          <Text style={styles.text2}>
            By using our website, you hereby consent to our Privacy Policy and
            agree to its terms.
          </Text>
          <Text style={styles.text1}>Information we collect</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>How we use your information</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Log Files</Text>
          <Text style={styles.text2}>
            Homei follows a standard procedure of using log files. These files
          ...
          <Text style={styles.text1}>Cookies and Web Beacons</Text>
          <Text style={styles.text2}>
            Like any other website, Homei uses 'cookies'. These cookies are used
          ...
          <Text style={styles.text2}>
            ...
            advertising partners of Homei. Third-party ad servers or ad networks
            ...
            Homei, which are sent directly to users' browser. They automatically
            receive your IP address when this occurs. These technologies are
            used to measure the effectiveness of their advertising campaigns
            and/or to personalize the advertising content that you see on
            websites that you visit. Note that Homei has no access to or control
            over these cookies that are used by third-party advertisers.
          </Text>
          <Text style={styles.text1}>Third Party Privacy Policies</Text>
          <Text style={styles.text2}>
            Homei's Privacy Policy does not apply to other advertisers or
          ...
          <Text style={styles.text1}>GDPR Data Protection Rights</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Children's Information</Text>
          <Text style={styles.text2}>
            Another part of our priority is adding protection for children while
            using the internet. We encourage parents and guardians to observe,
            participate in, and/or monitor and guide their online activity.
            Homei does not knowingly collect any Personal Identifiable

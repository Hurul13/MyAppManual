...
import { WARNA_BLACK, WARNA_BLUE, WARNA_BORDER, WARNA_GRAYTUA, WARNA_GREEN, WARNA_RED, WARNA_SEKUNDER, WARNA_SILVER, WARNA_UTAMA, WARNA_WHITE, WARNA_RED_PUDAR } from '../../utils/constant';
import { responsiveFontSize, responsiveHeight } from 'react-native-responsive-dimensions';
import IconMaterial from 'react-native-vector-icons/MaterialCommunityIcons';
import { ScrollView } from 'react-native-virtualized-view';
import Icon from 'react-native-vector-icons/FontAwesome';

const HistoryOrderDetailDibatalkan = ({ navigation, route }) => {
            ...
            return (
              <View key={index} style={styles.card}>
                ...
                <View style={styles.productInfo}>
                  ...
                  {/* <Text style={styles.productSubtotal}>alamat id: Rp {item.user_address_id}</Text> */}
                </View>
              </View>
            );
          })}
...
export default HistoryOrderDetailDibatalkan;
...
const styles = {
  ...
  checkoutButton: {
    backgroundColor: WARNA_RED_PUDAR,

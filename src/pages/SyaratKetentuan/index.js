    ...
    <ScrollView
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.judulBar}>Syarat & Ketentuan</Text>
        </View>
        <View style={styles.box}>
          <Text style={styles.text}>Terms and Conditions</Text>
          <Text style={styles.text2}>
            Last updated: March 25, 2022 Please read these terms and conditions
            carefully before using Our Service.
          </Text>
          <Text style={styles.text1}>Interpretation and Definitions</Text>
          <Text style={styles.text1}>Interpretation</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Definitions</Text>
          <Text style={styles.text2}>
            ...
            election of directors or other managing authority. Country refers
            to: Indonesia Company (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to Homei, Surabaya. Device
            ...
            by the Service. Website refers to Homei, accessible from
            https://homei.co.id You means the individual accessing or using the
            Service, or the company, or other legal entity on behalf of which
            such individual is accessing or using the Service, as applicable.
          </Text>
          <Text style={styles.text1}>Acknowledgment</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Termination</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Governing Law</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Disputes Resolution</Text>
          <Text style={styles.text2}>
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </Text>
          <Text style={styles.text1}>For European Union (EU) Users</Text>
          <Text style={styles.text2}>
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which you are
            resident in.
          </Text>
          <Text style={styles.text1}>United States Legal Compliance</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Severability and Waiver</Text>
          <Text style={styles.text1}>Severability</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Waiver</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text1}>Translation Interpretation</Text>
          <Text style={styles.text2}>
          ...
          <Text style={styles.text2}>
            ...
            contact us: By email: admin@homei.co.id
          </Text>
        </View>
      </View>
    </ScrollView>
